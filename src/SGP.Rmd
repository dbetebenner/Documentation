...
author: |
  | <a href="https://github.com/dbetebenner"><span style="font-size:2rem">Damian Betebenner</span></a>
  | <span style="color:#00274c font-size:2rem">Senior Associate </span>
  | <a href="https://github.com/centerforassessment"><span style="font-size:2rem">National Center for the Improvement of Educational Assessment</span></a>
date: '`r Sys.Date()`'
output:
  html_document:
...
library(SGP); library(data.table); library(SGPdata)
```
